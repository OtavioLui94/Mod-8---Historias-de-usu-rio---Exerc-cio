...
Funcionalidade: [US-0002] – Login na plataforma
    ...
    Cenário: Login de usuário com redirecionamento para a tela de checkout
        Quando o usuário informar os dados válidos de <email> e <senha>
        Então o usuário <nome> deve ser redirecionado para a tela de checkout, com uma <mensagem> na tela de "usuário <nome> logado com sucesso"